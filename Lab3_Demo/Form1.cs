...
namespace Lab3_Demo
{
    public partial class frmSinhVien : Form
    {
        ...
        //Lay thong tin tu controls thong tin SV
        private SinhVien GetSinhVien()
        {
            SinhVien sv = new SinhVien();
            bool gt = true;
            List<string> cn = new List<string>();
            sv.MaSo = this.mtxtbMaSo.Text;
        ...
        // Lay thong tin sinh vien tu dong item cua Listview
        ...
        //Thiet lap cac thong tin len controls sinh vien
        private void ThietLapThongTin(SinhVien sv)
        {
            this.mtxtbMaSo.Text = sv.MaSo;
        ...
        //khi chon dong sinh vien tren ListView
        //thuc hien gan thon tin len cac control
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            if (kq != null)
                MessageBox.Show("Ma sinh vien da ton tai!", "Loi them du lieu", MessageBoxButtons.OK, MessageBoxIcon.Error);
            else
            {
                this.qlsv.Them(sv);
                this.LoadListView();
